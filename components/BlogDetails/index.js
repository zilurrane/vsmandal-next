...
import './style.css'
import blog1 from '../../public/images/blog/img-4.jpg'
...
import blog6 from '../../public/images/blog/admin.jpg'
                        ...
                        <div className="wpo-wpo-blog-content clearfix">
                            <div className="post">
                                ...
                                <ul className="entry-meta">
                                    <li><Link href="/blog-details"><img src={blog6} alt=""/>  By Admin</Link></li>
                                    <li><Link href="/blog-details"><i className="ti-calendar"></i> Sep 25,2020</Link></li>
                                    <li><Link href="/blog-details"><i className="ti-heart"></i> 35</Link></li>
                                </ul>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <ul>
                                        ...
                                        <li><Link href="/blog-details">Marketing</Link></li>
                                        <li><Link href="/blog-details">SEO</Link></li>
                                    </ul>
                                </div>
                                <div className="share">
                                    <ul>
                                        <li><Link href="/blog-details"><i className="ti-facebook"></i></Link></li>
                                        <li><Link href="/blog-details"><i className="ti-twitter-alt"></i></Link></li>
                                        <li><Link href="/blog-details"><i className="ti-instagram"></i></Link></li>
                                    </ul>
                                </div>
                            </div> 
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-details" target="_blank"><img src={blog2} alt=""/>  </Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-details" className="author-name">Henry Joyes</Link>
                                    <p>Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised</p>
                                    <div className="author-btn">
                                        <Link href="/blog-details">All Post From Author</Link>
                                    </div>
                                </div>
                            </div> 
                                                    ...
                                                    <div className="comment-main-area">
                                                        <div className="comment-wrapper">
                                                            ...
                                                            <div className="comment-area">
                                                                <p>I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, </p>
                                                                <div className="comments-reply">
                                                                    <Link className="comment-reply-link" href="/blog-details"><span><i className="fa fa-reply" aria-hidden="true"></i> Reply</span></Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                    ...
                    <div className="row">
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <ul>
                                    <li><Link onClick={ClickHandler} href="/" passHref><i className="ti-facebook"></i></Link></li>
                                    <li><Link onClick={ClickHandler} href="/" passHref><i className="ti-twitter-alt"></i></Link></li>
                                    <li><Link onClick={ClickHandler} href="/" passHref><i className="ti-instagram"></i></Link></li>
                                    <li><Link onClick={ClickHandler} href="/" passHref><i className="ti-google"></i></Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
